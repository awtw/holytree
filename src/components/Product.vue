        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    堅持古法蒸餾萃取，保留最存粹乾淨的精油</h2>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">來自千年神木的精粹，淬鍊出台灣特有種的精華
                </p>
            </div>
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>激勵心臟，呼吸與循環功能，可以提昇低血壓，淨化充血的肺臟，使呼吸順暢，有助於人和身體發寒狀況，從普通的病菌到嚴重的肺炎都可以使用樟樹精油．助於腸胃發炎的消炎鎮定．</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <!-- <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            <span>蒸餾比率：1000斤材料 精露100斤 精油千分之十五</span>
                        </li>
                    </ul>
                    <!-- <a href="#"
                        class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">Get
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>台灣檜木所含之HinokiTiol成分有優越之抑制傷寒菌，大腸菌，白蘚菌，具消炎作用．使用於腎臟病，膀胱炎，尿毒症，慢性肝病之保健，解宿醉，痛風．</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <!-- <svg class="flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            <span>蒸餾比率：1000斤材料 精露100斤 精油千分之五</span>
                        </li>
                    </ul>
                    <!-- <a href="#"
                        class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">Get
            ...
            <!-- <button type="button"
                class="flex justify-center items-center mx-auto font-medium text-primary-600 dark-text-primary-400 hover:text-primary-700"
            ...
            <!-- <div id="detailed-pricing" class="hidden overflow-x-auto mt-8 w-full">
                <div class="overflow-hidden min-w-max">
                    ...
                    <div
                        ...
                        <div class="text-gray-500 dark:text-gray-400">Basic components (<a
                                href="https://flowbite.com/docs/components/alerts/"
                                class="text-primary-600 hover:underline">view all</a>)</div>
                        <div>
                    ...
                    <div
                        class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Application UI (<a href="/application-ui/preview/"
                                class="text-primary-600 hover:underline">view demo</a>)</div>
                        <div>
                    ...
                    <div
                        class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Free edition (<a href="#"
                                class="text-primary-600 hover:underline">duplicate in Figma</a>)</div>
                        <div>
                            <svg class="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <div
                        class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Application UI (<a href="#"
                                class="text-primary-600 hover:underline">preview in Figma</a>)</div>
                        <div>
                            <svg class="w-6 h-6 text-red-500" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <div
                        class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700">
                        <div class="text-gray-500 dark:text-gray-400">Marketing UI (<a href="#"
                                class="text-primary-600 hover:underline">preview in Figma</a>)</div>
                        <div>
                            <svg class="w-6 h-6 text-red-500" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div
                        ...
                        <div>
                            <a href="#"
                                class="text-white block w-full bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">Buy
                                now</a>
                        </div>
                        <div>
                            <a href="#"
